const Aside = () => {
    return (
        <>
            <div className="customizer d-none d-md-block ">
                <a className="customizer-close" href="#">
                    <i className="bx bx-x" />
                </a>
                <a className="customizer-toggle" href="#">
                    <i className="bx bx-cog bx bx-spin white" />
                </a>
                <div className="customizer-content p-2 ps ps--active-y">
                    ...
                    <div id="customizer-theme-colors">
                        ...
                        <ul className="list-inline unstyled-list">
                            <li
                                className="color-box bg-primary selected"
                            ...
                            <div className="icon-animation-switch">
                                <div className="custom-control custom-switch">
                                    <input
                                        ...
                                        defaultChecked
                                        id="icon-animation-switch"
                                    />
                                    <label
                                        className="custom-control-label"
                                        htmlFor="icon-animation-switch"
                                    />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="collapse-sidebar d-flex justify-content-between align-items-center">
                        ...
                        <div className="collapse-option-switch">
                            <div className="custom-control custom-switch">
                                ...
                                <label
                                    className="custom-control-label"
                                    htmlFor="collapse-sidebar-switch"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="customizer-navbar-colors">
                        ...
                        <ul className="list-inline unstyled-list">
                            <li
                                className="color-box bg-white border selected"
                                data-navbar-default
                            ></li>
                            <li
                        ...
                        <small>
                            <strong>نکته :</strong> این گزینه تنها در حالت نوار
                            ثابت و در هنگام اسکرول صفحه نمایش داده خواهد شد.
                        </small>
                        <hr />
                    </div>
                    {/* Navbar colors starts */}
                        ...
                        <div className="card-shadow-switch">
                            <div className="custom-control custom-switch">
                                <input
                                    type="checkbox"
                                    className="custom-control-input"
                                    id="card-shadow-switch"
                                />
                                <label
                                    className="custom-control-label"
                                    htmlFor="card-shadow-switch"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="hide-scroll-top-switch">
                            <div className="custom-control custom-switch">
                                <input
                                    type="checkbox"
                                    className="custom-control-input"
                                    id="hide-scroll-top-switch"
                                />
                                <label
                                    className="custom-control-label"
                                    htmlFor="hide-scroll-top-switch"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        style={{ top: 0, height: 374, left: 393 }}
                    >
                        <div
                            className="ps__thumb-y"
                            tabIndex={0}
                            style={{ top: 0, height: 127 }}
                        />
                    </div>
                </div>
            </div>
