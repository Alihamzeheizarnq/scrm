                        ...
                        <div className="row breadcrumbs-top">
                            ...
                            <div className="col-sm-4" style={{ textAlign: 'left' }}>
                                <button type="button"
                                    ...
                                    <span className="align-middle ml-25">ایجاد دسته بندی</span></button>
                            </div>
                        </div>
                        ...
                        <div className="card">
                            <div className="table-responsive">
                                <div id="table-extended-success_wrapper" className="dataTables_wrapper no-footer"><table id="table-extended-success" className="table mb-0 dataTable no-footer" role="grid">
                                    <thead>
                                        <tr role="row">
                                            <th className="sorting_disabled" rowSpan={1} colSpan={1} style={{ width: '250.531px' }}>نام</th>
                                            <th className="sorting_disabled" rowSpan={1} colSpan={1} >توضیحات</th>

                                            <th className="sorting_disabled" rowSpan={1} colSpan={1} aria-label="عمل" style={{ width: '51.6406px' }}>عملیات</th>
                                        </tr>
                                    </thead>
                                    <tbody>
...

                                        {
                                            props.category.map(item => (
                                                ...
                                                <tr role="row" className="even" key={item.id}>
                                                    <td>{item.title}</td>
                                                    <td className="text-bold-700">{item.body}</td>
                                                    <td>
                                                        <div className="d-flex">
                                                            <button type="button" class="btn btn-icon btn-light-secondary" style={{ marginLeft: '3px' }}>
