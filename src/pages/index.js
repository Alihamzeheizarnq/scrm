                        ...
                        <div className="card-content">
                            <div className="card-body">
                                <div className="card-text">
                                    <p>طرح 2 ستون متداول ترین و محبوب ترین طرح می باشد. این طرح دارای فهرست ناوبری می باشد و از بخش های نوار ناوبری و فوتر متداول استفاده می کند. با این حال میتوانید هدر و فوتر سفارشی به صفحه اضافه نمایید.</p>
                                    <div className="alert bg-rgba-warning mb-2" role="alert">
                                        طرح پیش فرض قالب مدیریت فرست 2 ستون می باشد. اگر طرح صفحه را تنظیم نکنید به صورت پیش فرض 2 ستون خواهد شد.
                                    </div>
                                </div>
                            </div>
                        </div>
